...
model1="models/construction_waste.model"
model2="models/treematter.model"
model3="models/plywood.model"
model4="models/cardboard.model"
model5="models/trashbags.model"
####################################################################
#Main program
